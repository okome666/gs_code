...
<html lang="ja">
  ...
  <div class="img-thumbnail">
    <img
      src="https://www.pakutaso.com/shared/img/thumb/tomneko12151291_TP_V.jpg"
      alt=""
    />
    <p class="img-title">';
...
if($status==false) {
  ...
  while( $result = $stmt->fetch(PDO::FETCH_ASSOC)){ 
    $view .= "<p>";
    $view .= $result["indate"].'<br>'.$result["name"].$result["vacant"].'　　'.$result["place"].'<br>'.'<a href='.$result["URL"].'>ポートフォリオ</a>';
    $view .= "</p>";
  }

}

echo($html1.$view.$html2);
?>
